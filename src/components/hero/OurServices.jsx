    ...
    <div class="row gy-5">
      <div class="col-12 col-sm-6 col-lg-4">
        <div class="text-center px-xl-2">
          ...
          <h5 class="m-2">New Build Homes</h5>
      ...
      <div class="col-12 col-sm-6 col-lg-4">
        <div class="text-center px-xl-2">
          ...
          <h5 class="m-2">House Extensions</h5>
      ...
      <div class="col-12 col-sm-6 col-lg-4">
        <div class="text-center px-xl-2">
          ...
          <h5 class="m-2">House Renovation</h5>
      ...
      <div class="col-12 col-sm-6 col-lg-4">
        <div class="text-center px-xl-2">
          ...
          <h5 class="m-2">Property Development</h5>
      ...
      <div class="col-12 col-sm-6 col-lg-4">
        <div class="text-center px-xl-2">
          ...
          <h5 class="m-2">Landscaping & External Works</h5>
      ...
      <div class="col-12 col-sm-6 col-lg-4">
        <div class="text-center px-xl-2">
          ...
          <h5 class="m-2">Commercial Construction</h5>
