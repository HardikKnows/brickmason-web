...
function Card(props) {
  return (
    ...
    <div className="max-w-sm p-6 m-2 mx-4 bg-white border border-gray-200 md:mx-2 lg:mx-4  shadow-[0px_0px_10px_0px_#6c757d57]  dark:border-[#fff] hover:shadow-[0px_0px_4px_0px_#d98e7d] ">
      <a>
        <div>
          <FontAwesomeIcon
            icon={props.icon}
